...
from ai_researcher.tools.youtube import youtube_transcript_reader, YoutubeTranscriptError
...
class TestYoutubeTranscriptReader:
    ...
    def test_short_youtube_url(self, mock_api_class):
        ...
        mock_api_instance.fetch.assert_called_with("xyz789", languages=['en', 'en-US', 'en-GB'])
