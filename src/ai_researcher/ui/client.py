...
import httpx
from ai_researcher.models.api_schemas import ResearchRequest, ActionRequest
...
class ResearchClient:
    ...
    async def start_research(self, question: str, thread_id: Optional[str] = None) -> str:
    ...
    async def stream_research(self, thread_id: str, question: Optional[str] = None) -> AsyncGenerator:
                ...
                async for line in response.aiter_lines():
                    if line.startswith("event: "):
                        ...
                        try:
                            ...
                            print(f"[CLIENT ERROR] Received invalid JSON in 'data:' line: {raw_data}")
    ...
    async def submit_action(self, thread_id: str, action: str, instructions: Optional[str] = None):
